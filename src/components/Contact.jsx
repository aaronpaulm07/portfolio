  ...
  return (
    <div className='root'>
      <div className='connn' id='connn'>
        ...
        <p className='para2'>I like to work with fun, open-minded people.<br/> Feel free to say hello!</p>
        ...
        <div className='address'> 
          ...
          <a className='linkedin' href='https://www.linkedin.com/in/aaron-paul-m07' target='_blank' rel='noopener noreferrer'>aaronpaulm07</a>
        </div>  
        <div className='end'/>
      </div>
    </div>
